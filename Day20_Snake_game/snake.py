...
class Snake:
    ...
    def move(self):
        '''
        The last segment follows the second last segment and second last follows the first
    ...
    def up(self):
        # If the current heading is pointed down, it can't move up, it cannot just go backwards
